...
const (
	...
	// CodexAccountSwitchWaitingSafeBoundary waits for active turns to settle.
	CodexAccountSwitchWaitingSafeBoundary CodexAccountSwitchPhase = "waiting_for_safe_boundary"
	...
	// CodexAccountSwitchCancelled means cancellation won before shutdown.
	CodexAccountSwitchCancelled CodexAccountSwitchPhase = "cancelled"
...
func (p CodexAccountSwitchPhase) Terminal() bool {
	return p == CodexAccountSwitchCompleted || p == CodexAccountSwitchCancelled || p == CodexAccountSwitchFailed
}
